            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex flex-column align-items-start pb-0">
                        ...
                        <p class="mb-0"><a href="" style="color: black">Total Logs</a></p>
                    </div>
                    <div class="card-content">
                        {{--                    <div id="orders-received-chart"></div>--}}
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex flex-column align-items-start pb-0">
                        ...
                        <p class="mb-0"><a href="{!! route('admin.contact-us.index') !!}?type=agent" style="color: black">Total Contact Form</a></p>
                    </div>
                    <div class="card-content">
                        {{--                    <div id="orders-received-chart"></div>--}}
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex flex-column align-items-start pb-0">
                        ...
                        <p class="mb-0"><a href="{!! route('admin.client.index') !!}" style="color: black">Total Client Form</a></p>
                    </div>
                    <div class="card-content">
